...
### Constants
DATA_PATH = "/content/drive/MyDrive/Traffic Signs Classification/train_data" # path to the dataset
LABEL_PATH = '/content/drive/MyDrive/Traffic Signs Classification/labels.csv' # path to the labels csv file
RESULT_PATH = "/content/drive/MyDrive/Traffic Signs Classification/model_trained.p" # path to the labels csv file
